...
const fileEditorCSS = path.resolve(theCWD, './assets/css/blocks.editor.style.css' );
const fileFrontendCSS = path.resolve(theCWD, './assets/css/blocks.frontend.style.css' );
